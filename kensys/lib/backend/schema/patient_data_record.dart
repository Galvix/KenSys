...
class PatientDataRecord extends FirestoreRecord {
  ...
  // "lastAttended" field.
  DateTime? _lastAttended;
  DateTime? get lastAttended => _lastAttended;
  bool hasLastAttended() => _lastAttended != null;

  // "timesAttended" field.
  List<DateTime>? _timesAttended;
  List<DateTime> get timesAttended => _timesAttended ?? const [];
  bool hasTimesAttended() => _timesAttended != null;
  ...
  void _initializeFields() {
    ...
    _lastAttended = snapshotData['lastAttended'] as DateTime?;
    _timesAttended = getDataList(snapshotData['timesAttended']);
  }
...
class PatientDataRecordDocumentEquality implements Equality<PatientDataRecord> {
  ...
  bool equals(PatientDataRecord? e1, PatientDataRecord? e2) {
    ...
    return e1?.doctorId == e2?.doctorId &&
        ...
        e1?.lastAttended == e2?.lastAttended &&
        listEquality.equals(e1?.timesAttended, e2?.timesAttended);
  }
