  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<NurseDataRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NurseDataRecord> homePageCopyNurseDataRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homePageCopyNurseDataRecord =
            homePageCopyNurseDataRecordList.isNotEmpty
                ? homePageCopyNurseDataRecordList.first
                : null;
