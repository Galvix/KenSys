          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                obscureText: false,
                decoration: InputDecoration(
                  labelText: 'Your Specialization',
                  labelStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Readex Pro',
                        color: Color(0xFF576168),
                      ),
                  hintStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Readex Pro',
                ...
                validator:
                    _model.specialityControllerValidator.asValidator(context),
              ),
            ),
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await NurseDataRecord.collection.doc().set({
                      ...createNurseDataRecordData(
                        nurseName: _model.yourNameController.text,
                        nurseId: currentUserUid,
                        spec: _model.specialityController.text,
                        nurImage: _model.uploadedFileUrl,
                      ),
                      ...mapToFirestore(
                        {
